...
let User = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)(), (0, typeorm_1.Unique)(["email"])];
    ...
    var User = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.tokens = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _tokens_initializers, void 0));
            this.tasks = (__runInitializers(this, _tokens_extraInitializers), __runInitializers(this, _tasks_initializers, void 0));
    ...
    (() => {
        ...
        _tokens_decorators = [(0, typeorm_1.OneToMany)(() => token_entity_1.default, token => token.user)];
        _tasks_decorators = [(0, typeorm_1.OneToMany)(() => task_entity_1.default, task => task.user)];
