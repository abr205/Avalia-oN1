...
let Token = (() => {
    ...
    var Token = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.userId = (__runInitializers(this, _expiresAt_extraInitializers), __runInitializers(this, _userId_initializers, void 0));
    ...
    (() => {
        ...
        _user_decorators = [(0, typeorm_1.ManyToOne)(() => user_entity_1.default, user => user.tokens)];
