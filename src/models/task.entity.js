...
let Task = (() => {
    ...
    var Task = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.title = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _title_initializers, void 0));
            this.completed = (__runInitializers(this, _title_extraInitializers), __runInitializers(this, _completed_initializers, void 0));
            this.userId = (__runInitializers(this, _completed_extraInitializers), __runInitializers(this, _userId_initializers, void 0));
    ...
    (() => {
        ...
        _user_decorators = [(0, typeorm_1.ManyToOne)(() => user_entity_1.default, user => user.tasks)];
